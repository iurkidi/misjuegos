...
use uni\bundle\misjuegosBundle\Entity\juego;
use uni\bundle\misjuegosBundle\Form\juegoType;
...
class juegoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('uniMisJuegosBundle:juego')->findAll();

        return $this->render('uniMisJuegosBundle:juego:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniMisJuegosBundle:juego:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniMisJuegosBundle:juego')->find($id);
        ...
        return $this->render('uniMisJuegosBundle:juego:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniMisJuegosBundle:juego:edit.html.twig', array(
            'entity'      => $entity,
